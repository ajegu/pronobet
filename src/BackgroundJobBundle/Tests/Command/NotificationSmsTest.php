...
use BackgroundJobBundle\Command\NotificationSmsCommand;
use Symfony\Bundle\FrameworkBundle\Console\Application;
use Symfony\Bundle\FrameworkBundle\Test\KernelTestCase;
use Symfony\Component\Console\Tester\CommandTester;

class NotificationSmsTest extends KernelTestCase
{
    private $application;
    private $em;
    ...
    public function setUp()
    {
        ...
        $this->application->add(new NotificationSmsCommand());
        ...
        $this->subscription->setStatus(SubscriptionStatus::Vip)
            ->setActivate(true)
            ->setAmount(0)
            ->setFees(0)
        ...
        // send message
        $queueUrl = self::$kernel->getContainer()->getParameter('aws_sqs.notification_sms');
    ...
    {
        $command = $this->application->find('notification:sms');
        ...
        $this->assertContains(
            'sms sent to ' . $this->user->getPhoneNumber(),
            $output
        );
    }
